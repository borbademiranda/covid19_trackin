...
# Resultados
A Figura \@ref(fig:cloud) ilustra as palavras mais frequentes nos *tweets* entre `r summary(tw$created_at)[[1]]` a `r summary(tw$created_at)[[6]]`
